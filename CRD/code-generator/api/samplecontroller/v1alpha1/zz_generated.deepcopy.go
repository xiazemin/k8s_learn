...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FooExpansion) DeepCopyInto(out *FooExpansion) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FooExpansion.
func (in *FooExpansion) DeepCopy() *FooExpansion {
	if in == nil {
		return nil
	}
	out := new(FooExpansion)
	in.DeepCopyInto(out)
	return out
}
